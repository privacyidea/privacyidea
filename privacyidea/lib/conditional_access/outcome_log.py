...
def outcome_for_stage(policy: ConditionalAccessPolicy, stage: ConditionalAccessPolicyStage, action_type: str, event_count: int, *,
                      dry_run: bool = False,
    ...
    :param action_type: the action that ran. Hinted ``str`` rather than ``ConditionalAccessAction``: that enum is a ``str``
