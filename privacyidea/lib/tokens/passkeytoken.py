...
class PasskeyTokenClass(TokenClass):
    ...
    def get_init_detail(self, params=None, user=None):
        ...
        if self.token.rollout_state == ROLLOUTSTATE.CLIENTWAIT:
            ...
            rp_id = get_required(params, Fido2Action.RELYING_PARTY_ID)
            rp_name = get_required(params, Fido2Action.RELYING_PARTY_NAME)
            ...
            # Key Algorithms
            pub_key_algorithms = get_optional(params, Fido2Action.PUBLIC_KEY_CREDENTIAL_ALGORITHMS,
            ...
            if Fido2Action.USER_VERIFICATION_REQUIREMENT in params:
                user_verification = UserVerificationRequirement(params[Fido2Action.USER_VERIFICATION_REQUIREMENT])
    ...
    def update(self, param, reset_failcount=True):
        ...
        if not (attestation and client_data) and not self.token.rollout_state == ROLLOUTSTATE.CLIENTWAIT:
            ...
            expected_rp_id = get_required(param, Fido2Action.RELYING_PARTY_ID)
