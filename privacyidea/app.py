...
from privacyidea.api.container import container_blueprint, container_sync_blueprint
...
def create_app(config_name="development",
    ...
    app.register_blueprint(container_sync_blueprint, url_prefix='/containersync')
