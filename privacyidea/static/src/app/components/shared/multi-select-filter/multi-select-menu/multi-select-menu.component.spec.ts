...
describe("MultiSelectMenuComponent", () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({ imports: [MultiSelectMenuComponent] }).compileComponents();
  ...
  it("creates and exposes its MatMenu via matMenu", () => {
    expect(component).toBeTruthy();
    expect(component.matMenu).toBeInstanceOf(MatMenu);
  });
  ...
  it("applies valueSuffix when toggling and matching against selected values", () => {
