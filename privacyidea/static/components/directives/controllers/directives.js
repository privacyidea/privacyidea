...
myApp.directive("selectOrCreateContainer", ["instanceUrl", "versioningSuffixProvider", "ContainerFactory",
    "$http", "containerUrl", "AuthFactory",
    function (instanceUrl, versioningSuffixProvider, ContainerFactory, $http, containerUrl, AuthFactory) {
        return {
            ...
            templateUrl: instanceUrl
                + "/static/components/directives/views/directive.selectorcreatecontainer.html"
                + versioningSuffixProvider.$get(),
            link: function (scope, element, attr) {
                scope.getContainers = function () {
                    $http.get(containerUrl + "/", {
                        ...
                        scope.containers = response.data.result.value;
                        ...
                        scope.containers.forEach(function (container) {
                            ...
                            if (container.users.length > 0) {
                                container.displayString += " of " + container.users[0].user_name + "@"
                                    + container.users[0].user_realm;
                            }
                        ...
                        // Add an extra container at the beginning to represent the creation of a new container
                ...
                // Watch for changes in the containerSerial in case it is loaded later than the directive is initialized
                ...
                ContainerFactory.getContainerTypes(function (data) {
                    scope.newContainer.types = data.result.value;
                });
                ...
                scope.createContainer = function () {
                    let params = {
                        type: scope.newContainer.type,
                        description: scope.newContainer.description,
                    }
                ...
                scope.assignUserToContainer = false;
            }
        };
    }]);