...
myApp.factory("ConfigFactory", ["AuthFactory", "$http", "$state", "$rootScope",
    ...
    function (AuthFactory, $http, $state, $rootScope,
        ...
        return {
            ...
            setRealmNode: function (name, nodeid, params, callback) {
                $http.post(realmUrl + "/" + name + "/node/" + nodeid, params, {
                    headers: {
                        'PI-Authorization': AuthFactory.getAuthToken(),
                        'Content-Type': 'application/json'
                    }
            ...
            revokeAllClientRememberedDevices: function (clientId, params, callback) {
