...
#  Jul 02, 2014 added machine controllers, Cornelius Kölbel
#  License:  AGPLv3
...
########################################################
    ...
    @log_with(log)
    def machinecreate(self, action, **params):
        '''
    ...
    @log_with(log)
    def machinedelete(self, action, **params):
        '''
    ...
    @log_with(log)
    def machineshow(self, action, **params):
        '''
