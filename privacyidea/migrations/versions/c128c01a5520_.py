...
def downgrade():
    ...
    try:
        ...
        # Look up the actual FK name. On a canonical install this is
        # 'tokencontainertemplate_id' (set explicitly by upgrade()), but a
        ...
        if migration_context.dialect.name in ['sqlite']:
            ...
            op.drop_constraint(fk_name, 'tokencontainer', 'foreignkey')
    except (OperationalError, ProgrammingError) as exx:
