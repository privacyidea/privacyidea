...
#
#  2014-10-02 Activate SMS tests. PEP8
...
class TestAuthorizeController(TestController):
    ...
    def initToken(self):
        ...
        resp = self.app.get(url(controller='admin', action='set'),
                            {'pin': '1234',
                             'serial': 'pw1'})
        assert '"status": true' in resp
    ...
    def test_02_horst_not_allowed(self):
        '''
        Auth Test 02: test if horst is not allowed to authenticate.
        horst is not authorized, since he is not mentioned in the
        policy1 as user.
        '''
        parameters = {'user': 'horst',
                      'pass': '1234secret2',
    ...
    def test_03_localuser_not_allowed(self):
        '''
        Auth Test 03: localuser not allowed to authenticate to another host
        than 172.16.200.X
...
#    horst    -> password test123
    ...
    def test_07_pinpolicy(self):
        '''
        Auth Test 07: check on a client, that is not contained in policy
    ...
    def test_08_pinpolicy(self):
        '''
        Auth Test 08: check user on client, but user not contained in policy
        for this client => authenticate with OTP PIN
        '''
...
#
    def test_10_tokentype(self):
        '''
        Auth Test 10: client not in policy. Every tokentype able to authenticate
        '''
        # clear pin policy
    ...
    def test_11_tokentype(self):
        '''
        Auth Test 11: Tokentype policy contains list of tokentypes.
        A token is allowed to authenticate
        '''
        parameters = {'name': 'tokentypepolicy1',
                      'scope': 'authorization',
                      'realm': '*',
    ...
    def test_12_tokentype(self):
        '''
        Auth Test 12: Tokentype policy contains list of tokentypes.
        the tokentype is not contained and not allowed to authenticate
        '''
        parameters = {'name': 'tokentypepolicy1',
                      'scope': 'authorization',
                      'realm': '*',
    ...
    def test_13_tokentype(self):
        '''
        Auth Test 13: Tokentype policy contains '*', the token type is allowed
        to authenticate.
        '''
        parameters = {'name': 'tokentypepolicy1',
                      'scope': 'authorization',
...
#  AutoSMS
    ...
    def test_20_autosms(self):
        '''
        Auth Test 20: autosms enabled with no client and no user.
        Will do for all clients in a realm
        '''
        ...
        parameters = {'user': 'horst',
                      'client': '1.2.3.4'}
        response = self.app.get(url(controller='testing', action='autosms'),
                                params=parameters)
    ...
    def test_21_autosms(self):
        '''
        Auth Test 21: autosms enabled for client. autosms for client in subnet
        '''
        self.setPolicy({'name': 'autosms',
                        'scope': 'authentication',
                        'realm': '*',
    ...
    def test_22_autosms(self):
        '''
        Auth Test 22: Will not send autosms for a client outside this subnet
        '''
        self.setPolicy({'name': 'autosms',
                        'scope': 'authentication',
                        'realm': '*',
    ...
    def test_23_autosms(self):
        '''
        Auth Test 23: autosms enabled for a client and for a user.
        Will send autosms for this user
        '''
        self.setPolicy({'name': 'autosms',
                        'scope': 'authentication',
                        'realm': '*',
    ...
    def test_24_autosms(self):
        '''
        Auth Test 24: autosms enabled. Will not send autosms for another user
        '''
        self.setPolicy({'name': 'autosms',
                        'scope': 'authentication',
                        'realm': '*',
...
#
    ...
    def test_34_setrealm(self):
        '''
        Auth Test 34: setrealm. rewrite realm to not existing realm. Auth fail
        '''
        self.setPolicy({"name": "setrealm",
                        "scope": "authorization",
