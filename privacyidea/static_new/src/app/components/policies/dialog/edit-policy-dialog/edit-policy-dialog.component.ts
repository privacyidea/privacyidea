...
import { PolicyDescriptionComponent } from "../../policy-panels/action-tab/policy-description/policy-description.component";
import { ActionTabComponent } from "../../policy-panels/action-tab/action-tab.component";
