...
import { PolicyPanelViewComponent } from "./policy-panel-view.component";
...
describe("PolicyPanelEditComponent", () => {
  let component: PolicyPanelViewComponent;
  let fixture: ComponentFixture<PolicyPanelViewComponent>;
  let policyServiceMock: MockPolicyService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [PolicyPanelViewComponent, NoopAnimationsModule, MatExpansionModule],
      providers: [
        provideHttpClient(),
    ...
    fixture = TestBed.createComponent(PolicyPanelViewComponent);
