...
import { ConditionsAdminComponent } from "./conditions-admin.component";
...
describe("ConditionsAdminComponent", () => {
  let component: ConditionsAdminComponent;
  let fixture: ComponentFixture<ConditionsAdminComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ConditionsAdminComponent, NoopAnimationsModule],
      providers: [
    ...
    fixture = TestBed.createComponent(ConditionsAdminComponent);
