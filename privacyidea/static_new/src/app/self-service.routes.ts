...
} from './components/token/token-enrollment/token-enrollment.self-service.component';
import {
  TokenDetailsSelfServiceComponent
} from './components/token/token-details/token-details.self-service.component';
import {
  ContainerTableSelfServiceComponent
} from './components/token/container-table/container-table.self-service.component';
import {
  ContainerCreateSelfServiceComponent
} from './components/token/container-create/container-create.self-service.component';
import {
  ContainerDetailsSelfServiceComponent
} from './components/token/container-details/container-details.self-service.component';
import { UserSelfServiceComponent } from './components/user/user.self-service.component';
import {
  AssignTokenSelfServiceComponent
} from './components/token/assign-token-self-service/assign-token-self-service.component';
import {
