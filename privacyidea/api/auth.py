...
def get_auth_token():
    ...
    **Example response**:
    ...
    if auth_event_type is None and not terminal_event_suppressed:
        ...
        # misattribute it to a wrong userstore password and skew password-failure conditional-access counters), mirroring
    ...
    # Feed the classified outcome to the conditional-access engine. Unlike the other endpoints this cannot wait for request
