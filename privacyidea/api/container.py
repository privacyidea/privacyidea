...
def registration_finalize():
    ...
    try:
        ...
        if Match.user(
            ...
            return send_error("Failed finalizing container registration"), map_error_to_code(e)
        raise
...
def registration_terminate_client():
    ...
    try:
        ...
        if Match.user(
            ...
            return send_error("Failed terminating container registration"), map_error_to_code(e)
        raise
...
def create_challenge():
    ...
    try:
        ...
        if Match.user(
            ...
            return send_error("Failed creating container challenge"), map_error_to_code(e)
        raise
...
def synchronize():
    ...
    try:
        ...
        if Match.user(
            ...
            return send_error("Failed container synchronization"), map_error_to_code(e)
        raise
...
def rollover():
    ...
    try:
        ...
        if Match.user(
            ...
            return send_error("Failed container rollover"), map_error_to_code(e)
        raise
