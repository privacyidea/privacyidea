...
* Deprecation of `/validate/samlcheck`: The endpoint will be removed in the future version **3.12**. If you are using that endpoint for one of your applications, please start using `validate/check` with the policies `add_user_in_response` and/or `add_resolver_in_response`.
