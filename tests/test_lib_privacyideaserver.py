...
class PrivacyIDEAServerTestCase(MyTestCase):
    ...
    def test_02_updateserver(self):
        r = add_privacyideaserver(identifier="myserver", url="https://pi/pi", tls=False)
        self.assertTrue(r > 0)
    ...
    def test_04_privacyidea_request(self):
        ...
        r = add_privacyideaserver(
            identifier="pi", url="https://privacyidea/pi", tls=False
        )
        self.assertTrue(r > 0)
        ...
        r = add_privacyideaserver(
            identifier="pi2", url="https://privacyidea/pi2", tls=False
        )
        self.assertTrue(r > 0)
        ...
        r = add_privacyideaserver(
            identifier="pi3", url="https://privacyidea/pi3", tls=False
        )
        self.assertTrue(r > 0)
        ...
        responses.add(
            responses.POST,
            "https://privacyidea/pi4/validate/check",
            body="""{
            "detail": null,
            "result": {
              "status": true,
        ...
        r = add_privacyideaserver(
            identifier="pi4", url="https://privacyidea/pi4", tls=False
        )
        self.assertTrue(r > 0)
