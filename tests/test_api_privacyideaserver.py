...
class PrivacyIDEAServerTestCase(MyApiTestCase):
    ...
    def test_01_create_server(self):
        ...
        with self.app.test_request_context(
            "/privacyideaserver/server1",
            method="POST",
            data={"url": "https://pi/pi", "tls": "0", "description": "myServer"},
        ):
        ...
        with self.app.test_request_context(
            "/privacyideaserver/server1",
            method="POST",
            data={"url": "https://pi", "tls": "0", "description": "myServer"},
        ...
        # list servers
        with self.app.test_request_context(
            "/privacyideaserver/", method="GET", headers={"Authorization": self.at}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
        ...
        with self.app.test_request_context(
            "/privacyideaserver/", method="GET", headers={"Authorization": self.at_user}
        ):
            res = self.app.full_dispatch_request()
    ...
    def test_02_test_conncection(self):
        ...
        with self.app.test_request_context(
            "/privacyideaserver/test_request",
            method="POST",
            data={
                "identifier": "server1",
                "tls": "0",
