...
class APIMachineResolverTestCase(MyApiTestCase):
    ...
    def test_01_pretestresolver(self):
        param = {"filename": HOSTSFILE, "type": "hosts"}
    ...
    def test_03_resolvers_ldap(self):
        # create a machine resolver
        with self.app.test_request_context(
            "/machineresolver/machineresolver2",
            data={
                "type": "ldap",
        ...
        with self.app.test_request_context(
            ...
            self.assertTrue("LDAPURI" in result["value"]["machineresolver2"]["data"])
