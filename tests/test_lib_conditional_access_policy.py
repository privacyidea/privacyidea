...
class ConditionalAccessPolicyCrudTestCase(MyTestCase):
    ...
    def test_02_create_validation_errors(self):
        ...
        self.assertRaises(ParameterError, create_conditional_access_policy, "P", 600, ["PIN_FAIL"],  # actions not a list
    ...
    def test_02f_count_mode_defaults_per_target(self):
        ...
        user_id = create_conditional_access_policy("U", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=1)
    ...
    def test_02b_duplicate_counter_types_are_deduplicated(self):
        ...
        policy_id = create_conditional_access_policy(
            "Dedup", 600, ["MFA_FAIL", "PIN_FAIL", "MFA_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=1
        )
    ...
    def test_03_list_and_order(self):
        ...
        create_conditional_access_policy("Low", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=1)
        create_conditional_access_policy(
    ...
    def test_05_update_validation(self):
        policy_id = create_conditional_access_policy("A", 600, ["PIN_FAIL"], [_stage(5)], target=ConditionalAccessTarget.USER, priority=1)
        create_conditional_access_policy("B", 600, ["PIN_FAIL"], [_stage(5)], target=ConditionalAccessTarget.USER, priority=2)
        ...
        self.assertRaises(
            ParameterError, update_conditional_access_policy, policy_id, name="StillA", stages=[{"failure_threshold": -1}]
        )
        db.session.rollback()
    ...
    def test_06_delete(self):
        policy_id = create_conditional_access_policy(
            "Doomed", 600, ["PIN_FAIL"], [_stage(5), _stage(10, priority=2)], target=ConditionalAccessTarget.USER, priority=1
        )
    ...
    def test_08_actions_by_target_is_exhaustive(self):
        ...
        self.assertSetEqual(
            set(ConditionalAccessTarget), set(_ACTIONS_BY_TARGET), "a ConditionalAccessTarget is missing from _ACTIONS_BY_TARGET"
        )
        covered = set().union(*_ACTIONS_BY_TARGET.values())
        self.assertSetEqual(set(ConditionalAccessAction), covered, "a ConditionalAccessAction is not assignable to any target")
    ...
    def test_09_count_modes_by_target_is_exhaustive(self):
        ...
        self.assertSetEqual(
            set(ConditionalAccessTarget), set(_COUNT_MODES_BY_TARGET), "a ConditionalAccessTarget is missing from _COUNT_MODES_BY_TARGET"
        )
        self.assertSetEqual(
    ...
    def test_11_duplicate_priority_rejected(self):
        ...
        create_conditional_access_policy("First", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=1)
        self.assertRaises(
            ParameterError,
            create_conditional_access_policy,
            "Second",
    ...
    def test_12_update_to_used_priority_rejected(self):
        first = create_conditional_access_policy("First", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=1)
        create_conditional_access_policy("Second", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=2)
    ...
    def test_13_update_keeping_own_priority_ok(self):
        policy_id = create_conditional_access_policy("Solo", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=5)
    ...
    def test_14_create_priority_race_reported_as_parameter_error(self):
        ...
        create_conditional_access_policy("Winner", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=1)
        ...
        create_conditional_access_policy("After", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=2)
    ...
    def test_15_update_priority_race_reported_as_parameter_error(self):
        create_conditional_access_policy("A", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=1)
        second = create_conditional_access_policy("B", 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER, priority=2)
        with mock.patch.object(
            policy_module, "_validate_priority", side_effect=lambda priority, exclude_id=None: priority
        ):
    ...
    def _create_with_conditions(self, name: str, conditions, priority: int = 1) -> int:
        ...
        return create_conditional_access_policy(name, 600, ["PIN_FAIL"], [_stage()], target=ConditionalAccessTarget.USER,
