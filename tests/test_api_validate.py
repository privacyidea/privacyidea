...
from privacyidea.lib.tokens.registrationtoken import (
...
LDAPDirectory = [
    {
        ...
        "attributes": {
            ...
            "objectGUID": "\xef6\x9b\x03\xc0\xe7\xf3B" "\x9b\xf9\xcajl\rM1",
            "mobile": ["1234", "45678"],
        },
    },
    {
        ...
        "attributes": {
            ...
            "objectGUID": "\xef6\x9b\x03\xc0\xe7\xf3B" "\x9b\xf9\xcajl\rMw",
            "oid": "3",
        },
    },
    {
        ...
        "attributes": {
            ...
            "accountExpires": 9223372036854775807,
            "objectGUID": "\xef6\x9b\x03\xc0\xe7\xf3B" "\x9b\xf9\xcajl\rMT",
            "oid": "1",
        },
    },
    {
        ...
        "attributes": {
            ...
            "userPassword": "ldaptest",
            "accountExpires": 9223372036854775807,
            "objectGUID": "\xef7\x9b\x03\xc0\xe7\xf3B" "\x9b\xf9\xcajl\rMT",
            "oid": "5",
        },
    },
]
...
class AuthorizationPolicyTestCase(MyApiTestCase):
    ...
    def test_02_enroll_tokens(self):
        ldap3mock.setLDAPDirectory(LDAPDirectory)
        r = init_token(
            {"type": "spass", "pin": "spass"},
            user=User(login="alice", realm="ldaprealm"),
        )
        self.assertTrue(r)
        # The token gets assigned to frank in the resolver catchall
        r = init_token(
            {"type": "spass", "pin": "spass"},
            user=User(login="frank", realm="ldaprealm"),
        )
        self.assertTrue(r)
        self.assertEqual("{0!s}".format(r.user), "<frank.catchall@ldaprealm>")

        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": "frank", "pass": "spass"}
        ):
    ...
    def test_03_classic_policies(self):
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": "alice", "pass": "spass"}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_04_testing_token_with_setrealm(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"serial": "SPASS_04", "pass": "1234"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
...
class DisplayTANTestCase(MyApiTestCase):
    def test_00_run_complete_workflow(self):
        ...
        with self.app.test_request_context(
            "/token/load/ocra.csv",
            method="POST",
            data={"type": "oathcsv", "file": (IMPORTFILE, "oath.csv")},
...
def setup_sms_gateway():
    ...
    responses.add(responses.POST, post_url, body=success_body)
...
class AValidateOfflineTestCase(MyApiTestCase):
    ...
    def test_01_validate_offline(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "pin287082"},
...
class ValidateAPITestCase(MyApiTestCase):
    ...
    def test_02_validate_check(self):
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"pass": "pin287082"}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 400, res)
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"serial": "123456"}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 400, res)
    ...
    def test_03a_check_user_get(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="GET",
            query_string=urlencode({"user": "cornelius", "pass": "pin287082"}),
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_04_check_serial(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"serial": self.serials[0], "pass": "pin969429"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            ...
            self.assertTrue(result.get("value") is False, result)
            self.assertEqual(
                details.get("message"), "wrong otp value. " "previous otp used again"
            )

    def test_05_check_serial_with_no_user(self):
        # Check a token per serial when the token has no user assigned.
        init_token({"serial": "nouser", "otpkey": self.otpkey, "pin": "pin"})
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"serial": "nouser", "pass": "pin359152"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_05a_check_otp_only(self):
        ...
        init_token({"serial": "otponly", "otpkey": self.otpkey, "pin": "pin"})
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"serial": "otponly", "otponly": "1", "pass": "359152"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_06_fail_counter(self):
        ...
        init_token(
            {"serial": "s2", "genkey": 1, "pin": "test"},
            user=User("cornelius", self.realm1),
        )
        init_token(
            {"serial": "s3", "genkey": 1, "pin": "test"},
            user=User("cornelius", self.realm1),
        )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "XXXX123456"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "pin123456"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_07_authentication_counter_exceeded(self):
        token_obj = init_token({"serial": "pass1", "pin": "123456", "type": "spass"})
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"serial": "pass1", "pass": "123456"}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
            ...
            self.assertTrue("Authentication counter exceeded" in detail.get("message"))

    def test_08_failcounter_counter_exceeded(self):
        token_obj = init_token({"serial": "pass2", "pin": "123456", "type": "spass"})
        token_obj.set_maxfail(5)
        token_obj.set_failcount(5)
        # a valid authentication will fail
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"serial": "pass2", "pass": "123456"}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
            ...
            self.assertEqual(result.get("value"), False)
            self.assertEqual(
                detail.get("message"), "matching 1 tokens, " "Failcounter exceeded"
            )
    ...
    def test_10_saml_check(self):
        ...
        with self.app.test_request_context(
            "/validate/samlcheck",
            method="POST",
            data={"user": "cornelius", "pass": "pin338314"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/samlcheck",
            method="POST",
            data={"user": "cornelius", "pass": "pin254676"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
            ...
            attributes = value.get("attributes")
            self.assertEqual(value.get("auth"), True)
            self.assertEqual(attributes.get("email"), "user@localhost.localdomain")
    ...
    def test_11_challenge_response_hotp(self):
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": "cornelius", "pass": pin}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_11a_challenge_response_registration(self):
        ...
        with self.app.test_request_context(
            "/policy/pol_chal_resp",
            data={
                "action": "challenge_response=registration",
                "scope": "authentication",
                "realm": "",
                "active": True,
            },
    ...
    def test_11b_challenge_response_multiple_hotp_failcounters(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertGreaterEqual(
                result["value"]["setPolicy pol_chal_resp"], 1, result
            )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": chalresp_pins[0]},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_11c_challenge_response_timezone(self):
        ...
        # create a token and assign to the user
        init_token(
            {"serial": serial, "type": "hotp", "otpkey": self.otpkey, "pin": pin},
            user=User("cornelius", self.realm1),
        )
    ...
    def test_12_challenge_response_sms(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertFalse(result.get("value"))
            self.assertEqual(
                detail.get("message"), "No active challenge response token found"
            )
    ...
    def test_13_challenge_response_email(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "state": transaction_id, "pass": "359152"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_14_check_validity_period(self):
        ...
        password = serial
        init_token(
            {"serial": serial, "type": "spass", "pin": password},
            user=User("cornelius", self.realm1),
        )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": password},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_15_validate_at_sign(self):
        ...
        serial2 = "Split002"
        init_token(
            {"serial": serial1, "type": "spass", "pin": serial1},
            user=User("cornelius", self.realm1),
        )

        init_token(
            {"serial": serial2, "type": "spass", "pin": serial2},
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": serial1},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius@" + self.realm2, "pass": serial2},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 400, res)
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius%40" + self.realm2, "pass": serial2},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_16_autoresync_hotp(self):
        serial = "autosync1"
        token = init_token(
            {"serial": serial, "otpkey": self.otpkey, "pin": "async"},
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius@" + self.realm2, "pass": "async399871"},
        ):
            res = self.app.full_dispatch_request()
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius@" + self.realm2, "pass": "async520489"},
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            result = res.json.get("result")
    ...
    def test_16_autoresync_hotp_via_multichallenge(self):
        ...
        set_privacyidea_config("AutoResync", True)
        set_policy(
            name="mcr_resync", scope=SCOPE.AUTH, action=ACTION.RESYNC_VIA_MULTICHALLENGE
        )
        token.set_sync_window(10)
        token.set_count_window(5)
        # counter = 8, is out of sync
        with self.app.test_request_context(
            ...
            detail = res.json.get("detail")
            self.assertEqual(
                detail.get("multi_challenge")[0].get("message"),
    ...
    def test_17_auth_timelimit_success(self):
        ...
        for i in [1, 2]:
            with self.app.test_request_context(
                "/validate/check",
                method="POST",
                data={"user": "timelimituser", "realm": self.realm2, "pass": pin},
            ):
                res = self.app.full_dispatch_request()
                self.assertTrue(res.status_code == 200, res)
                result = res.json.get("result")
    ...
    def test_18_auth_timelimit_fail(self):
        ...
        with self.app.test_request_context(
            ...
            details = res.json.get("detail")
            self.assertEqual(
                details.get("message"), "Only 2 failed authentications per 0:00:20"
            )
    ...
    def test_19_validate_passthru(self):
        ...
        with self.app.test_request_context(
            ...
            query_string=urlencode(
                {"user": "passthru", "realm": self.realm2, "pass": "pthru"}
            ),
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "passthru", "realm": self.realm2, "pass": "pthru"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        set_policy(
            name="reset_all_tokens", scope=SCOPE.AUTH, action=ACTION.RESETALLTOKENS
        )
        # Passthru with POST Request
        with self.app.test_request_context(
            "/validate/check",
    ...
    def test_20_questionnaire(self):
        ...
        # Start a challenge
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"serial": serial, "pass": pin}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"serial": serial, "transaction_id": transaction_id, "pass": answer},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_21_validate_disabled(self):
        ...
        # enroll two tokens
        r = init_token(
            {"type": "spass", "serial": "spass1d"},
            user=User("disableduser", self.realm2),
        )
        r = init_token(
            {"type": "spass", "serial": "spass2d"},
            user=User("disableduser", self.realm2),
        )
        # disable first token
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "disableduser", "realm": self.realm2, "pass": "superSecret"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_22_validate_locked(self):
        ...
        r = init_token(
            {"type": "spass", "serial": "spass2l", "pin": "locked"},
            user=User(user, self.realm2),
        )
        # disable first token
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": user, "realm": self.realm2, "pass": "locked"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_23_pass_no_user_and_pass_no_token(self):
        ...
        set_policy(
            name="pass_no",
            scope=SCOPE.AUTH,
            action="{0!s},{1!s}".format(ACTION.PASSNOTOKEN, ACTION.PASSNOUSER),
        )

        r = init_token(
            {"type": "spass", "serial": serial, "pin": pin},
            user=User(user, self.realm2),
        )
        self.assertTrue(r)
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": user, "realm": self.realm2, "pass": pin},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "doesNotExist", "realm": self.realm2, "pass": pin},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": user_no_token, "realm": self.realm2, "pass": pin},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
            ...
            detail = res.json.get("detail")
            self.assertEqual(
                detail.get("message"), "user has no token, " "accepted due to 'pass_no'"
            )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": user, "realm": self.realm2, "pass": "wrongPiN"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
            self.assertEqual(result.get("value"), False)
            detail = res.json.get("detail")
            self.assertEqual(detail.get("message"), "wrong otp pin")
    ...
    def test_23a_pass_no_user_resolver(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "MisterX", "realm": self.realm1, "pass": "secret"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            detail = res.json.get("detail")
            self.assertEqual(
                detail.get("message"), "user does not exist, accepted due to 'pol1'"
            )
        delete_policy("pol1")
    ...
    def test_24_trigger_challenge(self):
        ...
        with self.app.test_request_context(
            ...
            detail = res.json.get("detail")
            self.assertEqual(
                detail.get("messages")[0], _("Enter the OTP from the SMS:")
            )
    ...
    def test_26_multiple_challenge_response(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(transaction_id, multi_challenge[0].get("transaction_id"))
            self.assertEqual("interactive", multi_challenge[0].get("client_mode"))
            self.assertEqual(transaction_id, multi_challenge[1].get("transaction_id"))
    ...
    def test_27_multiple_challenge_response_different_pin(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "multichal", "realm": self.realm1, "pass": pinB},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_30_return_different_tokentypes(self):
        ...
        init_token(
            {"serial": "PW1", "type": "pw", "otpkey": "123", "pin": "hallo"}, user
        )
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "hallo123"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        init_token({"serial": "SPASS1", "type": "spass", "pin": "hallo123"}, user)
        ...
        remove_token("PW1")
        init_token({"serial": "SPASS2", "type": "spass", "pin": "hallo123"}, user)
        ...
        init_token(
            {"serial": "HOTP1", "type": "hotp", "otpkey": self.otpkey, "pin": "hallo"},
            user,
        )
        ...
        set_policy(
            "onlyHOTP", scope=SCOPE.AUTHZ, action="{0!s}=hotp".format(ACTION.TOKENTYPE)
        )
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": "passthru", "pass": "pthru"}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            result = res.json.get("result")
    ...
    def test_30_challenge_text(self):
        ...
        init_token(
            {"serial": "CHAL1", "type": "sms", "phone": "123456", "pin": "sms"}, user
        )
        init_token(
            {
                "serial": "CHAL2",
        ...
        set_policy(
            "chalsms",
            SCOPE.AUTH,
            "sms_{0!s}=check your sms".format(ACTION.CHALLENGETEXT),
        )
        set_policy(
            "chalemail",
            SCOPE.AUTH,
            "email_{0!s}=check your email".format(ACTION.CHALLENGETEXT),
        )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "email"},
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            resp = res.json
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": "cornelius", "pass": "sms"}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            resp = res.json
        ...
        init_token(
            {"serial": "CHAL3", "type": "sms", "phone": "123456", "pin": "PIN"}, user
        )
        init_token(
            {
                "serial": "CHAL4",
    ...
    def test_01_check_invalid_input(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(
                "ERR905: You need to specify a serial or a user.", error_msg
            )

        # wrong username
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": "h%h", "pass": ""}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 400, res)
            result = res.json.get("result")
        ...
        # wrong serial
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"serial": "*", "pass": ""}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 400, res)
            result = res.json.get("result")
    ...
    def test_31_count_auth(self):
        serial = "authcount001"
        tok = init_token({"serial": serial, "type": "spass", "pin": "spass"})
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"serial": serial, "pass": "spass"}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_32_secondary_login_attribute(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "Cooper", "realm": "tr", "pass": "spass"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_33_auth_cache(self):
        ...
        set_policy(
            name="authcache",
            action="{0!s}=4m".format(ACTION.AUTH_CACHE),
            scope=SCOPE.AUTH,
        )
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "realm": self.realm1, "pass": OTPs[1]},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        cached_auths = AuthCache.query.filter(
            AuthCache.username == "cornelius", AuthCache.realm == self.realm1
        ).all()
        found = False
        ...
        with self.app.test_request_context(
            ...
            detail = res.json.get("detail")
            self.assertEqual(
                detail.get("message"), "wrong otp value. previous otp used again"
            )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "realm": self.realm1, "pass": OTPs[2]},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        r = AuthCache.query.filter(
            AuthCache.authentication == _hash_password(OTPs[2])
        ).first()
    ...
    def test_35_application_tokentype(self):
        ...
        self.assertTrue(
            "tok_hotp" in triggered_serials and "tok_totp" in triggered_serials
        )

        # check that both serials appear in the audit log
        ae = self.find_most_recent_audit_entry(action="POST /validate/triggerchallenge")
        self.assertTrue(
            {"tok_hotp", "tok_totp"}.issubset(set(ae.get("serial").split(","))), ae
        )

        # Set a policy, that the application is allowed to specify tokentype
        set_policy(
            name="pol_application_tokentype",
            scope=SCOPE.AUTHZ,
        ...
        triggered_serials = [item["serial"] for item in detail.get("multi_challenge")]
        self.assertTrue(
            "tok_hotp" in triggered_serials and "tok_totp" not in triggered_serials
        )
    ...
    def test_36_authorize_by_tokeninfo_condition(self):
        init_token(
            {"type": "spass", "serial": "softwareToken", "pin": "software1"},
            tokenkind="software",
            user=User("cornelius", self.realm1),
        )
        init_token(
            {"type": "spass", "serial": "hardwareToken", "pin": "hardware1"},
            tokenkind="hardware",
            user=User("cornelius", self.realm1),
        )
        set_policy(
            name="always_deny_access",
            action="{0!s}=deny_access".format(ACTION.AUTHORIZED),
            scope=SCOPE.AUTHZ,
            priority=100,
        )
        # policy to allow tokens, condition is deactivated. All tokens will be authorized
        set_policy(
            name="allow_hardware_tokens",
            action="{0!s}=grant_access".format(ACTION.AUTHORIZED),
            scope=SCOPE.AUTHZ,
            priority=1,
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "realm": self.realm1, "pass": "software1"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "realm": self.realm1, "pass": "hardware1"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "realm": self.realm1, "pass": "wrongpassword"},
        ):
            res = self.app.full_dispatch_request()
    ...
    def test_03b_check_previous_otp_with_totp(self):
        token = init_token(
            {"type": "totp", "serial": "totp_previous", "otpkey": self.otpkey},
            user=User("cornelius", self.realm1),
        )
        # get the OTP
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="GET",
            query_string=urlencode({"user": "cornelius", "pass": otp_now}),
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
...
class RegistrationValidity(MyApiTestCase):
    ...
    def test_00_registrationtoken_with_validity_period(self):
        r = init_token({"type": "registration"}, user=User("cornelius", self.realm1))
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": quote(password)},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
            ...
            self.assertEqual(
                "matching 1 tokens, Outside validity period",
                detail.get("message"),
                (detail, password),
            )
...
class RegistrationAndPasswordToken(MyApiTestCase):
    ...
    def test_00_registration_tokens(self):
        ...
        with self.app.test_request_context(
            "/token/init",
            method="POST",
            data={"user": "cornelius", "type": "registration"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": quote(regcode)},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
            self.assertEqual(
                "ACCEPT", data.get("result").get("authentication"), (data, regcode)
            )
        ...
        with self.app.test_request_context(
            "/token/init",
            method="POST",
            data={"user": "cornelius", "type": "registration", "genkey": 1},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        with self.app.test_request_context(
            "/token/init",
            method="POST",
            data={"user": "cornelius", "type": "registration", "otpkey": "hallo"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "hallo"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
    ...
    def test_01_password_tokens(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(905, error.get("code"))
            self.assertEqual(
                "ERR905: Missing parameter: 'otpkey'", error.get("message"), data
            )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "testtopsecret"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
        ...
        with self.app.test_request_context(
            "/token/init",
            method="POST",
            data={"user": "cornelius", "type": "pw", "genkey": 1, "pin": "test"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(200, res.status_code)
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": quote("test{0!s}".format(password))},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
            self.assertEqual(
                "ACCEPT", data.get("result").get("authentication"), (data, password)
            )
        # delete token
        remove_token(serial)
    ...
    def test_02_application_specific_password_token(self):
        ...
        with self.app.test_request_context(
            "/token/init",
            method="POST",
            data={"user": "cornelius", "type": "applspec"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(400, res.status_code)
        ...
        with self.app.test_request_context(
            "/token/init",
            method="POST",
            data={"user": "cornelius", "genkey": "1", "type": "applspec"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(400, res.status_code)
            ...
            self.assertEqual(905, error.get("code"))
            self.assertEqual(
                "ERR905: Missing parameter: 'service_id'", error.get("message"), data
            )
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual("REJECT", data.get("result").get("authentication"), data)
            self.assertEqual(
                "No suitable token found for authentication.",
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(
                "matching 1 tokens", data.get("detail").get("message"), data
            )
...
class WebAuthn(MyApiTestCase):
    ...
    def setUp(self):
        ...
        set_policy(
            "wan1", scope=SCOPE.ENROLL, action="webauthn_relying_party_id=example.com"
        )
        set_policy(
            "wan2", scope=SCOPE.ENROLL, action="webauthn_relying_party_name=example"
        )
...
↵uj0TB5-XjlmAvivyWLi9WSI7pCJYIEJicw0LtP_hdy8yh6ANEUXBJsWtkGDci9DcN1rDG1tE"""
        ...
        self.assertEqual(
            get_tokens(serial=self.serial)[0].token.description, "my description"
        )
...
↵uj0TB5-XjlmAvivyWLi9WSI7pCJYIEJicw0LtP_hdy8yh6ANEUXBJsWtkGDci9DcN1rDG1tE"""
        ...
        with self.app.test_request_context(
            ...
            data = res.json
            self.assertEqual(
                "Yubico U2F EE Serial 61730834",
                data.get("detail").get("webAuthnRegisterResponse").get("subject"),
            )

        # Test, if the token received the automatic description
        self.assertEqual(
            get_tokens(serial=self.serial)[0].token.description,
            "Yubico U2F EE Serial 61730834",
        )
    ...
    def test_10_validate_check(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": self.username, "pass": self.pin},
            headers={"Host": "pi.example.com", "Origin": "https://pi.example.com"},
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(200, res.status_code)
            data = res.json
...
class MultiChallege(MyApiTestCase):
    ...
    def test_00_pin_change_via_validate_chalresp(self):
        ...
        set_policy(
            "via_validate", scope=SCOPE.AUTH, action=ACTION.CHANGE_PIN_VIA_VALIDATE
        )
        set_policy(
            "hotp_chalresp",
            scope=SCOPE.AUTH,
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": "cornelius", "pass": "test"}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            result = res.json["result"]
    ...
    def test_02_challenge_text_header(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(
                "{0!s}<li>Please enter a new PIN</li>\n".format(challenge_header),
                details.get("message"),
            )
    ...
    def test_04_preferred_client_mode_default(self):
        ...
        pin = "test49"
        init_token(
            {"serial": "CR2AAA", "type": "hotp", "otpkey": OTPKEY2, "pin": pin}, user
        )
        init_token(
            {"serial": "CR2B", "type": "hotp", "otpkey": self.otpkey, "pin": pin}, user
        )
...
class PushChallengeTags(MyApiTestCase):
    ...
    def test_01_push_challenge_tags(self):
        ...
        set_policy(
            "push1",
            scope=SCOPE.AUTH,
            action=PUSH_ACTION.MOBILE_TEXT
            + "=Login von UserAgent: {ua_string} via {client_ip}/{tokentype}.",
        )
        ...
        with self.app.test_request_context(
            "/validate/check", method="POST", data={"user": self.user, "pass": pin}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            detail = res.json.get("detail")
        ...
        with self.app.test_request_context(
            "/ttype/push",
            method="GET",
            data={"serial": serial, "timestamp": ts, "signature": b32encode(sig)},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
            value = result.get("value")
            self.assertEqual(
                "Login von UserAgent:  via None/push.", value[0].get("question")
            )
...
class AChallengeResponse(MyApiTestCase):
    ...
    def test_01_challenge_response_token_deactivate(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "selfservice", "pass": "pin"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
        ...
        with self.app.test_request_context(
            ...
            detail = data.get("detail")
            self.assertTrue(
                "No active challenge response" in detail.get("message"),
                detail.get("message"),
            )
    ...
    def test_07_disabled_sms_token_will_not_trigger_challenge(self):
        ...
        with self.app.test_request_context(
            ...
            detail = data.get("detail")
            self.assertEqual(
                "No active challenge response token found", detail.get("message")
            )
    ...
    def test_08_challenge_text(self):
        ...
        set_policy(
            name="pol_footer",
            scope=SCOPE.AUTH,
            action="{0!s}=</ul>.<b>Authenticate Now!</b>".format(
        ...
        init_token(
            {"serial": "tok1", "otpkey": self.otpkey, "pin": "pin"},
            user=User("cornelius", self.realm1),
        )
        init_token(
            {"serial": "tok2", "otpkey": self.otpkey, "pin": "pin"},
            user=User("cornelius", self.realm1),
        )
    ...
    def test_09_challenge_response_inc_failcounter(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(
                "Response did not match the challenge.", detail.get("message")
            )
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(
                "Response did not match for 2 tokens.", detail.get("message")
            )
    ...
    def test_10_unique_transaction_id(self):
        ...
        r = init_token(
            {"serial": "tok1", "type": "hotp", "otpkey": self.otpkey},
            user=User("cornelius", self.realm1),
        )
        self.assertTrue(r)
        r = init_token(
            {"serial": "tok2", "type": "tiqr", "otpkey": self.otpkey},
            user=User("cornelius", self.realm1),
        )
        self.assertTrue(r)
        ...
        set_policy(
            "chalresp",
            scope=SCOPE.AUTHZ,
            action="{0!s}=hotp".format(ACTION.TRIGGERCHALLENGE),
        )
    ...
    def test_11_validate_radiustoken(self):
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "radiuspassword"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius", "pass": "correctPW"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            data = res.json
    ...
    def test_12_polltransaction(self):
        ...
        with self.app.test_request_context(
            "/validate/polltransaction", method="GET", data={}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 400)
        ...
        with self.app.test_request_context(
            "/validate/polltransaction", method="GET", data={"transaction_id": "*"}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
        ...
        with self.app.test_request_context(
            "/validate/polltransaction", method="GET", data={"transaction_id": "123456"}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            self.assertTrue(res.json["result"]["status"])
        ...
        entry = self.find_most_recent_audit_entry(action="*/validate/polltransaction*")
        self.assertEqual(
            entry["action_detail"], "transaction_id: {}".format(transaction_id)
        )
        self.assertEqual(entry["info"], "status: pending")
        self.assertIn("tok1", entry["serial"])
        self.assertIn("tok2", entry["serial"])
        ...
        entry = self.find_most_recent_audit_entry(action="*/validate/polltransaction*")
        self.assertEqual(
            entry["action_detail"], "transaction_id: {}".format(old_transaction_id)
        )
        self.assertEqual(entry["info"], "status: pending")
        self.assertEqual(entry["serial"], None)
        self.assertFalse(entry["success"])
        ...
        Challenge.query.filter_by(serial="tok1", transaction_id=transaction_id).update(
            {"otp_valid": True}
        )
        db.session.commit()
        ...
        with self.app.test_request_context(
            "/validate/polltransaction/{}".format(transaction_id), method="GET", data={}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            self.assertTrue(res.json["result"]["status"])
        ...
        with self.app.test_request_context(
            "/validate/polltransaction/{}".format(transaction_id),
            method="GET",
            data={"transaction_id": transaction_id},
        ):
            res = self.app.full_dispatch_request()
    ...
    def test_13_chal_resp_indexed_secret(self):
        ...
        password = None
        with self.app.test_request_context(
            "/validate/check", data={"user": "cornelius", "pass": "test"}
        ):
            res = self.app.full_dispatch_request()
            self.assertEqual(res.status_code, 200)
            response = res.json
            ...
            random_positions = (
                response.get("detail").get("attributes").get("random_positions")
            )
        ...
        with self.app.test_request_context(
            ...
            self.assertFalse(result.get("status"))
            self.assertEqual(
                "ERR401: The indexedsecret token has an empty secret "
    ...
    def test_15_questionnaire_multichallenge(self):
        ...
        for i in range(0, 5):
            with self.app.test_request_context(
                ...
                data={
                    "user": "cornelius",
                    "pass": questionnaire.get(question),
                    "transaction_id": transaction_id,
                },
            ):
                res = self.app.full_dispatch_request()
    ...
    def test_16_4eyes_multichallenge_with_pin(self):
        ...
        tok = init_token(
            {"type": "4eyes", "4eyes": required_tokens, "pin": "pin", "serial": serial},
        ...
        with self.app.test_request_context(
            ...
            transaction_id = detail.get("transaction_id")
            self.assertEqual(
                "Please authenticate with another token from either realm: realm3.",
                detail.get("message"),
            )
    ...
    def test_17_4eyes_multichallenge(self):
        ...
        tok = init_token(
            {"type": "4eyes", "4eyes": required_tokens, "serial": serial},
            user=User("root", self.realm3),
        )
        self.assertTrue(tok.get_tokeninfo("4eyes"), "realm1:1,realm3:2")
    ...
    def test_19_increase_failcounter_on_challenge(self):
        ...
        # Create SMS token
        init_token(
            {"type": "sms", "serial": self.serial_sms, "phone": "123456", "pin": "pin"},
            user=User("cornelius", self.realm1),
        )
...
class TriggeredPoliciesTestCase(MyApiTestCase):
    ...
    def test_00_two_policies(self):
        ...
        set_policy(
            "lastauth", scope=SCOPE.AUTHZ, action="{0!s}=1s".format(ACTION.LASTAUTH)
        )
...
class MultiChallengeEnrollTest(MyApiTestCase):
    ...
    def test_01_enroll_HOTP(self, capture):
        ...
        with self.app.test_request_context(
            ...
            transaction_id = detail.get("transaction_id")
            self.assertTrue(
                "Please scan the QR code and enter the OTP value!"
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "alice", "transaction_id": transaction_id, "pass": otp},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
        ...
        self.assertIn(
            "Exiting get_init_tokenlabel_parameters with result {'force_app_pin': True}",
            log_msg,
            log_msg,
        )
    ...
    def test_02_enroll_TOTP(self):
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(
                ...
                detail.get("multi_challenge")[0].get("client_mode"),
            )
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "alice", "transaction_id": transaction_id, "pass": "123"},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            result = res.json.get("result")
    ...
    def test_03_enroll_EMail(self):
        ...
        with self.app.test_request_context(
            ...
            transaction_id = detail.get("transaction_id")
            self.assertTrue(
                "Please enter your new email address!" in detail.get("message"),
                detail.get("message"),
            )
            # Get image and client_mode
            self.assertEqual(CLIENTMODE.INTERACTIVE, detail.get("client_mode"))
    ...
    def test_04_enroll_SMS(self):
        ...
        set_policy(
            "pol_multienroll_text",
            scope=SCOPE.AUTH,
            action="{0!s}='Phone number enter you must!'".format(
        ...
        with self.app.test_request_context(
            ...
            transaction_id = detail.get("transaction_id")
            self.assertTrue(
                "Phone number enter you must!" in detail.get("message"),
                detail.get("message"),
            )
            # Get image and client_mode
            self.assertEqual(CLIENTMODE.INTERACTIVE, detail.get("client_mode"))
...
class WebAuthnOfflineTestCase(MyApiTestCase):
    ...
    serial = "WAN0001D434"
    clientdata = (
        "eyJ0eXBlIjoid2ViYXV0aG4uY3JlYXRlIiwiY2hhbGxlbmdlIjoiMGZueEhXNVIybWFPclZydUxK\r\nR3JFR0ZwRm1KSF"
        "I0alBFbWVkSjlQdDNoayIsIm9yaWdpbiI6Imh0dHBzOi8vcHVjay5vZmZpY2Uu\r\nbmV0a25pZ2h0cy5pdCIsImNyb3NzT"
        "3JpZ2luIjpmYWxzZX0"
    )
    regdata = (
        "o2NmbXRmcGFja2VkZ2F0dFN0bXSjY2FsZyZjc2lnWEcwRQIhAMjdckoGnrQ7mI4afrFD9Gf1eYKX\r\n1nij_v7PsyGb1RXBAiB"
    ...
    recorded_allow_credentials = (
        "RuBlEInU7ycsILST7u6AoT7rdqNYjSf4jlz38x10344xM2SHl"
    ...
    refilltokens = []
    user_agents = [
        "privacyidea-cp/1.1.1 Windows/Laptop-1231312",
        "privacyidea-cp/2.2.2 ComputerName/PC-ASDASDS",
    ]
    ...
    def setUp(self):
        ...
        set_policy(
            "wan2", scope=SCOPE.ENROLL, action="webauthn_relying_party_name=privacyIDEA"
        )
    ...
    def _trigger_and_modify_challenge(self, headers):
        payload = {"user": self.username, "pass": self.pin}
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(self.serial, data.get("detail").get("serial"))
            self.assertEqual(
                "Please confirm with your WebAuthn token (my description)",
                data.get("detail").get("message"),
            )
            detail = data.get("detail")
            ...
            self.assertEqual(
                self.recorded_allow_credentials, allow_credentials[0].get("id")
            )
            transaction_id = detail.get("transaction_id")

            # Update the recorded challenge in the DB
            recorded_challenge_hex = hexlify_and_unicode(
                webauthn_b64_decode(self.recorded_challenge)
            )
            # Update the nonce in the challenge database.
            from privacyidea.lib.challenge import get_challenges
    ...
    def test_02_authenticate(self):
        ...
        for i in range(len(self.user_agents)):
            ...
            self.assertEqual(
                self.recorded_allow_credentials, response.get("credentialId")
            )
    ...
    def test_04_refill_no_machine_name(self):
        ...
        payload = {
            "refilltoken": self.refilltokens[0],
            "serial": self.serial,
            "pass": "",
        }
        with self.app.test_request_context(
    ...
    def test_05_refill_per_machine(self):
        ...
        for i in range(len(self.user_agents)):
            payload = {
                "refilltoken": self.refilltokens[i],
                "serial": self.serial,
                "pass": "",
            }
            headers.update({"User-Agent": self.user_agents[i]})
            with self.app.test_request_context(
                ...
                self.assertEqual(
                    self.serial, data.get("auth_items").get("offline")[0].get("serial")
                )
                self.refilltokens[i] = (
                    data.get("auth_items").get("offline")[0].get("refilltoken")
                )
