...
class AuditTestCase(MyTestCase):
    ...
    def test_03_lib_search(self):
        res = search(self.app.config, {"page": 1, "page_size": 10, "sortorder": "asc"})
    ...
    def test_04_lib_download(self):
        ...
        for audit_entry in audit_log:
            self.assertTrue(
                type(audit_entry).__name__ in ["unicode", "str"],
    ...
    def test_06_truncate_data(self):
        ...
        self.assertEqual(
            "Berlin,Hamburg,München,Köln,Frankfu+,Stuttga+,Düsseld+,Dortmund,Essen,Leipzig,Bremen,"
    ...
    def test_09_check_external_audit_db(self):
        ...
        with mock.patch(
            "privacyidea.lib.auditmodules.sqlaudit.create_engine"
        ) as engine_mock:
    ...
    def test_11_check_audit_columns(self):
        ...
        # The tokentype was actually written as token_type
        self.assertEqual(
            set(audit_log.auditdata[0].keys()),
...
class AuditFileTestCase(OverrideConfigTestCase):
    ...
    def test_30_logger_audit_qualname(self, capture):
        ...
        with mock.patch(
            "privacyidea.lib.auditmodules.loggeraudit.datetime"
        ) as mock_timestamp:
            with mock.patch(
                "privacyidea.lib.auditmodules.base.datetime.datetime"
            ) as mock_startdate:
...
class ContainerAuditTestCase(OverrideConfigTestCase):
    ...
    def test_20_container_audit_wrong_module(self):
        ...
        module_config = {
            "PI_AUDIT_CONTAINER_WRITE": [
                "privacyidea.lib.auditmodules.doesnotexist",
                "privacyidea.lib.auditmodules.sqlaudit",
            ],
            "PI_AUDIT_CONTAINER_READ": "privacyidea.lib.auditmodules.sqlaudit",
            "PI_AUDIT_NO_SIGN": True,
