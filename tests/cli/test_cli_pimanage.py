...
class PIManageAdminTestCase(unittest.TestCase):
...
class PIManageAuditTestCase(unittest.TestCase):
...
class PIManageBackupTestCase(unittest.TestCase):
    def test_01_pimanage_backup_help(self):
        ...
        self.assertIn("Usage: pi-manage backup restore [OPTIONS] BACKUP_FILE",
                      result.output, result)
