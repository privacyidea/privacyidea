...
from privacyidea.lib.tokens.u2f import (
...
class U2FHelperFuncTestCase(MyTestCase):
    def test_01_check_reg_data(self):
        attestation_cert = (
            "3082013c3081e4a003020102020a4790128000115595735230"
    ...
    def test_02_parse_reg_date(self):
        ...
        self.assertEqual(
            key_handle,
            "69e4e0ea91c4644799438e2e60e41a07482727107bbf49084455d60a869d600e14183f6c7e16152c59c275fe20c45c977cd6fd7e38d9036badd1724af5eb6dae",
        )
        self.assertEqual(
            user_pub_key,
            "04459ddf17b5f673b132baf153caeb805c8e2a20fd9cf260dbb38da686c293e74a989fc5aa90578ff820cc559464b708ba1098d011e353123316471b474434b466",
        )
    ...
    def test_04_check_response(self):
        ...
        user_pub_key = "04d368f1b665bade3c33a20f1e429c7750d5033660c019119d29aa4ba7abc04aa7c80a46bbe11ca8cb5674d74f31f8a903f6bad105fb6ab74aefef4db8b0025e1d"
...
class U2FTokenTestCase(MyTestCase):
    ...
    def test_04_broken_reg_data(self):
        reg_data = (
            "BgT3NET2RTTcgzAiZRW5gkg3TT6mgQBepZl96iMtj-nXU25VdwBXCL1EjW"
...
class MultipleU2FTokenTestCase(MyTestCase):
    ...
    reg_data1 = (
        "BQSUSmNE4buL5xIqMlaRyJSMHhSvr37LpTT2e-zxyVoY21dzl1gZwcTws9I8r"
    ...
    client_data1 = (
        "eyJjaGFsbGVuZ2UiOiJJeF9HbWo1SkVFYktDR3k0QV9BVVZFYWRGTWNJam"
        "hBOC1meTJha1ZFaUFRIiwib3JpZ2luIjoiaHR0cHM6Ly9sb2NhbGhvc3Q6"
        "NTAwMCIsInR5cCI6Im5hdmlnYXRvci5pZC5maW5pc2hFbnJvbGxtZW50In0"
    )

    reg_data2 = (
        "BQREKCB4dlbzcqkU7T1talLdlX8pV-aJa0ijSpM2JIXg490mvhXVRquJuSkhr"
    ...
    client_data2 = (
        "eyJjaGFsbGVuZ2UiOiJUdU84MDVPTEQzdXpUNmNnalZ6blRJSjRrZXg4N"
