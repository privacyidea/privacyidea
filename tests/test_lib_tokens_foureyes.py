...
class FourEyesTokenTestCase(MyTestCase):
    ...
    def test_01_convert_realm(self):
        ...
        self.assertEqual(r, {"realm1": 2, "realm2": 1})
    ...
    def test_03_authenticate(self):
        ...
        init_token(
            {"type": "pw", "otpkey": "password1", "pin": "pin1", "serial": "pwserial1"},
            user=User("cornelius", self.realm1),
        )

        init_token(
            {"type": "pw", "otpkey": "password2", "pin": "pin2", "serial": "pwserial2"},
            user=User("cornelius", self.realm1),
        )

        init_token(
            {"type": "pw", "otpkey": "password3", "pin": "pin3", "serial": "pwserial3"},
            user=User("cornelius", self.realm1),
        )
