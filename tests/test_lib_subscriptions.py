...
class SubscriptionApplicationTestCase(MyTestCase):
    ...
    def test_03_check_subscription(self):
        ...
        with self.assertRaisesRegex(
            SubscriptionError, "Verifying the signature of your subscription"
        ):
            save_subscription(sub1)
        ...
        with self.assertRaisesRegex(
            SubscriptionError, "Signature of your subscription does not"
        ):
            save_subscription(sub1)
