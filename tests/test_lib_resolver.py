...
import json
import ssl
from privacyidea.lib.resolvers.LDAPIdResolver import (
...
LDAPDirectory_curly_objectGUID = [
    {
        "dn": "cn=bob,ou=example,o=test",
        "attributes": {
            "cn": "bob",
...
class LDAPResolverTestCase(MyTestCase):
    ...
    def test_13_add_user_update_delete(self):
        ...
        r = y.update_user(user_id, {"email": "", "givenname": "Charlie"})
        self.assertTrue(r)
        userinfo = y.getUserInfo(user_id)
    ...
    def test_29_sizelimit(self):
        ...
        with mock.patch.object(
            ...
            self.assertTrue(
                ret[1]
                in [
                    "Your LDAP config seems to be OK, 1 user objects found.",
    ...
    def test_32_cache_expiration(self):
        ...
        with mock.patch(
            "privacyidea.lib.resolvers.LDAPIdResolver.datetime.datetime",
        ...
        self.assertEqual(
            CACHE[y.getResolverId()]["getUserId"]["bob"],
            {
                "value": bob_id,
    ...
    def test_35_persistent_serverpool(self):
        ldap3mock.setLDAPDirectory(LDAPDirectory)
        params = {
            "LDAPURI": "ldap://localhost, ldap://127.0.0.1, ldap://127.0.1.1",
            "LDAPBASE": "o=test",
            "BINDDN": "cn=manager,ou=example,o=test",
            "BINDPW": "ldaptest",
            "LOGINNAMEATTRIBUTE": "cn",
...
class ResolverTestCase(MyTestCase):
    ...
    def test_12_passwdresolver(self):
        ...
        self.assertEqual(y.getUserInfo("1116").get("givenname"), "Nön")
    ...
    def test_15_try_to_delete_used_resolver(self):
        ...
        self.assertTrue(rid > 0, rid)
        added, failed = set_realm("myrealm", [{"name": self.resolvername1}])
