...
class APIServiceIDTestCase(MyApiTestCase):
    def test_01_set_get_delete_serviceid(self):
        ...
        # get services
        with self.app.test_request_context(
            "/serviceid/", method="GET", headers={"Authorization": self.at}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            value = res.json["result"]["value"]
        ...
        # get 1st service
        with self.app.test_request_context(
            "/serviceid/serviceA", method="GET", headers={"Authorization": self.at}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            value = res.json["result"]["value"]
        ...
        # delete 1st service
        with self.app.test_request_context(
            "/serviceid/serviceA", method="DELETE", headers={"Authorization": self.at}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            value = res.json["result"]["value"]
        ...
        # delete 2nd service
        with self.app.test_request_context(
            "/serviceid/serviceB", method="DELETE", headers={"Authorization": self.at}
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
            value = res.json["result"]["value"]
