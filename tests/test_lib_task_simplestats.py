...
class TaskSimpleStatsTestCase(MyTestCase):
    ...
    def test_00_read_simplestats_to_monitoringstats(self):
        ...
        init_token(
            {"type": "totp", "otpkey": self.otpkey, "serial": self.serials[1]},
        ...
        token = init_token(
            {"type": "totp", "otpkey": self.otpkey, "serial": self.serials[2]},
            tokenkind=TOKENKIND.HARDWARE,
        ...
        token = init_token(
            {"type": "totp", "otpkey": self.otpkey, "serial": self.serials[3]},
