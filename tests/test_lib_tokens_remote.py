...
class RemoteTokenTestCase(MyTestCase):
    ...
    serial1 = "ser1"
    params1 = {
        "remote.server": "http://my.privacyidea.server",
    ...
    def test_01_create_token(self):
        ...
        self.assertTrue(token.token.tokentype == "remote", token.token.tokentype)
    ...
    def test_21_create_remote_token_with_remote_server_id(self):
        ...
        db_token.save()
        token = RemoteTokenClass(db_token)
        token.update({"remote.server_id": r_server_id, "remote.serial": "123456"})
