...
class BasePeriodicTaskTestCase(MyTestCase):
    def test_01_calculate_next_timestamp_utc(self):
        ...
        self.assertEqual(
            calculate_next_timestamp(task1, "foo", tzinfo),
        ...
        self.assertEqual(
            calculate_next_timestamp(task1, "baz", tzinfo),
        ...
        self.assertEqual(
            calculate_next_timestamp(task1b, "foo", tzinfo),
            parse_timestamp("2018-06-24 08:00 UTC"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            calculate_next_timestamp(task2, "localhost", tzinfo),
        ...
        self.assertEqual(
            calculate_next_timestamp(task3, "localhost", tzinfo),
    ...
    def test_02_calculate_next_timestamp_localtime(self):
        ...
        self.assertEqual(
            calculate_next_timestamp(task, "foo", tzinfo),
        ...
        self.assertEqual(
            calculate_next_timestamp(task, "this_node_does_not_exist", tzinfo),
            parse_timestamp("2018-06-24 05:00 UTC"),
        )
        ...
        task = {
            ...
            "last_runs": {
                ...
                ),  # this is actually monday 00:00 in russia
            },
        }
        self.assertEqual(
            calculate_next_timestamp(task, "foo", tzinfo),
    ...
    def test_03_crud(self):
        ...
        task1_modified = set_periodic_task(
            "every month",
            "0 0 1 * *",
            ["pinode1"],
            "some.task.module",
        ...
        # ordered by ordering
        self.assertEqual(
            [task["name"] for task in all_tasks],
        ...
        self.assertEqual(
            [task["name"] for task in active_tasks], ["task three", "every month"]
        )
        ...
        self.assertEqual(
            [task["name"] for task in active_tasks_on_pinode2],
            ["task two", "task three"],
        )
        ...
        self.assertEqual(
            [task["name"] for task in active_tasks_on_pinode1],
    ...
    def test_04_last_run(self):
        ...
        set_periodic_task_last_run(
            task1_id, "pinode1", parse_timestamp("2018-06-26 08:00+02:00")
        )
        set_periodic_task_last_run(
            task1_id, "pinode1", parse_timestamp("2018-06-26 08:05+02:00")
        )
        ...
        self.assertEqual(
            task1["last_runs"]["pinode1"], parse_timestamp("2018-06-26 06:05 UTC")
        )

        set_periodic_task_last_run(
            task1_id, "pinode2", parse_timestamp("2018-06-26 08:10+01:00")
        )
        set_periodic_task_last_run(
            task1_id, "pinode3", parse_timestamp("2018-06-26 08:10-08:00")
        )
        task1 = get_periodic_tasks("task one")[0]
        self.assertEqual(
            task1["last_runs"]["pinode1"], parse_timestamp("2018-06-26 06:05 UTC")
        ...
        self.assertEqual(
            task1["last_runs"]["pinode2"], parse_timestamp("2018-06-26 07:10 UTC")
        )
        self.assertEqual(
            task1["last_runs"]["pinode3"], parse_timestamp("2018-06-26 16:10 UTC")
        )
    ...
    def test_05_scheduling(self):
        ...
        task4 = set_periodic_task(
            "task four", "0 0 1 8 *", ["pinode2"], "some.task.module", 0
        )
        ...
        self.assertEqual(
            [task["name"] for task in get_periodic_tasks()],
        ...
        set_periodic_task_last_run(
            task3, "pinode1", parse_timestamp("2018-08-01 00:00+03:00")
        )
        set_periodic_task_last_run(
            task3, "pinode2", parse_timestamp("2018-08-01 00:00+03:00")
        )
