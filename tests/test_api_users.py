...
class APIUsersTestCase(PristineSqliteFixtures, MyApiTestCase):
    ...
    def test_16_resolver_is_bound_to_the_admins_realms(self):
    ...
    def test_17_token_and_container_assign_reject_a_foreign_resolver(self):
    ...
    def test_18_user_scoped_grant_does_not_revoke_a_realm_grant(self):
    ...
    def test_19_unrestricted_grant_wins_regardless_of_policy_order(self):
