...
class APIUsersTestCase(MyApiTestCase):
    ...
    def test_02_create_update_delete_user(self):
        ...
        with self.app.test_request_context(
            "/user/",
            method="GET",
            query_string=urlencode({"username": "wordy"}),
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
    ...
    def test_03_create_update_delete_unicode_user(self):
        ...
        # Delete the users
        with self.app.test_request_context(
            "/user/{0!s}/{1!s}".format(resolver, "wördy").encode("utf-8"),
            method="DELETE",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
    ...
    def test_10_additional_attributes(self):
        ...
        with self.app.test_request_context(
            "/user/attribute",
            method="GET",
            data={"user": "cornelius@realm1", "key": "newattribute"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        with self.app.test_request_context(
            "/user/",
            method="GET",
            data={"realm": "realm1", "username": "cornelius"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        init_token(
            {"serial": "SPASS1", "type": "spass", "pin": "test"},
        ...
        with self.app.test_request_context(
            "/validate/check",
            method="POST",
            data={"user": "cornelius@realm1", "pass": "test"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        with self.app.test_request_context(
            ...
            self.assertEqual(
                "You are not allowed to delete the custom user attribute newattribute!",
                error.get("message"),
            )
        ...
        with self.app.test_request_context(
            "/user/attribute/doesnotexist/cornelius/realm1",
            method="DELETE",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
        ...
        set_policy("custom_create_user", scope=SCOPE.ADMIN, action=ACTION.ADDUSER)
        # CREATE a user
        self._create_user_wordy()
        ...
        with self.app.test_request_context(
            "/user/attribute",
            method="POST",
            data={"user": "wordy@sqlrealm", "key": "hello", "value": "one"},
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
        ...
        with self.app.test_request_context(
            "/user/attribute/hello/wordy/sqlrealm",
            method="DELETE",
            headers={"Authorization": self.wordy_auth_token},
        ):
            res = self.app.full_dispatch_request()
            ...
            error = result.get("error")
            self.assertEqual(
                "You are not allowed to delete the custom user attribute hello!",
                error.get("message"),
            )
        ...
        with self.app.test_request_context(
            "/user/attribute",
            method="POST",
            data={"key": "newattr", "value": "newvalue"},
            headers={"Authorization": self.wordy_auth_token},
        ):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 403, res)
            ...
            error = result.get("error")
            self.assertEqual(
                "You are not allowed to set the custom user attribute newattr!",
                error.get("message"),
            )
