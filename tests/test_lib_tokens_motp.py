...
class MotpTokenTestCase(MyTestCase):
    ...
    def test_03_enroll_genkey(self):
        ...
        db_token.save()
        token = MotpTokenClass(db_token)
        token.update({"genkey": "1", "motppin": self.motppin, "pin": self.otppin})
    ...
    def test_16_init_detail(self):
        ...
        self.assertTrue(
            motpurl == "motp://privacyidea:mylabel?" "secret=11223344556677889900",
            motpurl,
        )
    ...
    def test_04_class_methods(self):
        ...
        self.assertTrue(info.get("title") == "mOTP Token", info.get("title"))
