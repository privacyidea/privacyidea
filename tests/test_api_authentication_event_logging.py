...
class _AuthLogContractTests(_ContractHost):
    ...
    # --- multichallenge correlation: one logical attempt across a transaction change ---------------------------
    # A challenge answer that triggers a fresh challenge gets a new transaction_id, yet every row of the attempt
    # shares one attempt_id, recovered across that change, which is what assert_authentication_log verifies.
