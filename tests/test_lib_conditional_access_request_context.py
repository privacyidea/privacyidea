...
class ConditionalAccessContextTestCase(MyTestCase):
    ...
    def test_22c_reclassify_leaves_a_conditional_access_rejection_alone(self):
        ...
        # the CA_ENFORCEMENT_EVENT_TYPES guard in run_post_eval and into the conditional-access counters.
    ...
    def test_34_post_eval_records_what_the_engine_returned(self):
        ...
        self.assertListEqual([str(ConditionalAccessAction.PERMANENT_LOCK_USER)], [outcome.action_type for outcome in outcomes])
