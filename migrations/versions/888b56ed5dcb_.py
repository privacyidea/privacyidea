...
def upgrade():
    try:
        ...
        op.create_index(
            op.f("ix_customuserattribute_resolver"),
            "customuserattribute",
            ["resolver"],
            unique=False,
        )
        op.create_index(
            op.f("ix_customuserattribute_user_id"),
            "customuserattribute",
            ["user_id"],
            unique=False,
        )
...
def downgrade():
    op.drop_index(
        op.f("ix_customuserattribute_user_id"), table_name="customuserattribute"
    )
    op.drop_index(
        op.f("ix_customuserattribute_resolver"), table_name="customuserattribute"
    )
