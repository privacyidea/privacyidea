...
def upgrade():
    try:
        # As we defined 'priority' to be non-NULLable, we supply a server_default value of 0
        # here to set the priority of all existing policies to 0.
        op.add_column('policy', sa.Column('priority', sa.Integer(), nullable=False, server_default='0'))
