...
def upgrade():
    try:
        ...
        op.create_index(
            op.f("ix_authcache_realm"), "authcache", ["realm"], unique=False
        )
        op.create_index(
            op.f("ix_authcache_resolver"), "authcache", ["resolver"], unique=False
        )
        op.create_index(
            op.f("ix_authcache_username"), "authcache", ["username"], unique=False
        )
