...
.. glossary::
   ...
   Time Window
        ...
        ``Timestep`` and ``timewindow`` are completely similar to the ``counter`` and ``countwindow``
        (:ref:`tokeninfo`) of HOTP tokens.
   ...
   Radius Attribute Mapping
        ...
        **Using the Token serial number:**
        ...
        You can get it here `here <https://github.com/privacyidea/FreeRADIUS/blob/master/dictionary.netknights>`_.
   ...
   Subscription
        ...
        For the product privacyIDEA we provide the suitable `support <https://netknights.it/en/produkte/privacyidea/>`_
        with a defined response time and with fixed costs.
