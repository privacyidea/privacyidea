...
**********************
Exports the found tokens in a format that can be imported into privacyIDEA. The encryption key for the exported
file is auto-generated by the command and displayed to the user. This key is required for the privacyIDEA import.
...
``--file``
    ...
    Example::
        ...
        pi-tokenjanitor find --tokenattribute 'serial=OATH0004C934' export_for_privacyidea --file /path/to/privacyidea_export.txt
